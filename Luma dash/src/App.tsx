...
import { BarChart3, HeartPulse, Home, MessageCircle, User } from "lucide-react";
...
type TabKey = "home" | "chat" | "analytics" | "exercises" | "profile";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E8FFF5] to-[#F6FAFF] font-body text-slate-800">
      ...
      <main className="pb-20">
        {activeTab === "home" && (
          <WelcomePage onStartChat={() => setActiveTab("chat")} />
        )}
