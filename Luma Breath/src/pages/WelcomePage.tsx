...
export const WelcomePage = ({ onStartChat, onOpenMoodCanvas }: WelcomePageProps) => {
  const actionTiles: ActionTile[] = [
    ...
    },
    {
      ...
      actionLabel: "Open MoodCanvas",
      onClick: onOpenMoodCanvas,
    },
  ];
      ...
      <section className="rounded-4xl border border-white/60 bg-white/80 p-6 shadow-2xl backdrop-blur">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,0.8fr)]">
          <div className="space-y-4 text-emerald-900">
            ...
            <button className="inline-flex items-center justify-center rounded-full bg-emerald-500 px-5 py-2.5 text-sm font-semibold text-white shadow-lg transition hover:bg-emerald-600">
