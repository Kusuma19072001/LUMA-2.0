...
import { getAnalyticsHistory, type AnalyticsSnapshot } from "../utils/indexedDB";
...
function getWeekData(history: AnalyticsSnapshot[]) {
...
function getStreaks(history: AnalyticsSnapshot[]) {
...
function calcWellbeing(s: AnalyticsSnapshot) {
  return (
...
export default function AnalyticsPage() {
  ...
  const prevMoodEntry = weekPrev.length
    ? [...weekPrev].sort((a, b) => new Date(b.timestamp).getTime() - new Date(a.timestamp).getTime())[0] : undefined;
